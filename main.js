...
// let viewMatrix = defaultViewMatrix;  // Comment this out
let viewMatrix = getViewMatrix(cameras[0]);  // Start from camera 0
async function main() {
    let carousel = false;  // Disable carousel at start
    ...
    const url = new URL(
        // "nike.splat",
        // location.href,
        params.get("url") || "my.splat",
        "https://dimakuzov.github.io/splat-viewer/assets/",
    );
    ...
    window.addEventListener("keydown", (e) => {
        ...
        if (e.code == "KeyV") {
            ...
            const camToWorld = invert4(viewMatrix);
            const position = [camToWorld[12], camToWorld[13], camToWorld[14]];
            const rotation = [
                [camToWorld[0], camToWorld[1], camToWorld[2]],
